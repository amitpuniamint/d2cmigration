...
//Arrest/Surrender Date Masking
        ...
        $('#chsdateime').blur(function(event){
            var dtVal=$('#chsdateime').val();
            if(ValidateChargeheetDate(dtVal)) {
...
function ValidateChargeheetDate(date){
