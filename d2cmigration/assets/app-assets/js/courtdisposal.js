...
else if (is_acc_compensation == 'Y' && $("#cdacccompensationamt").find(":selected").val() == "" )
{
  document.getElementById("cdaccuseddisposaltype_error").innerHTML = "";
  document.getElementById("cdaccusedtypeofpunish_error").innerHTML = "";
  document.getElementById("cdacccompensationto_error").innerHTML = "";
...
else if (is_acc_compensation == 'Y' && $("#cdacccompensationby").find(":selected").val() == "" )
{
  document.getElementById("cdaccuseddisposaltype_error").innerHTML = "";
  document.getElementById("cdaccusedtypeofpunish_error").innerHTML = "";
  document.getElementById("cdacccompensationto_error").innerHTML = "";
...
else if (is_acc_compensation == 'Y' && $("#cdacccompensationcourtorder").find(":selected").val() == "" )
{
  document.getElementById("cdaccuseddisposaltype_error").innerHTML = "";
  document.getElementById("cdaccusedtypeofpunish_error").innerHTML = "";
  document.getElementById("cdacccompensationto_error").innerHTML = "";
