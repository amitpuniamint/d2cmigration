...
function load_property(row){
    setTimeout(function(){
        $("#fir_property_category").val(row.category_val).trigger("blur").trigger("change");
    }, 8);
    setTimeout(function(){
...
function update_accused(row_id){
    ...
    else if($("#fir_accusedpolice_name").val() == "")
    {
    ...
    else if($("#fir_accusedpolice_rank").find(":selected").val() == "" )
{

    document.getElementById("fir_accusedpolice_rank_error").innerHTML = "";
    document.getElementById("fir_accgender_error").innerHTML = "Select Rank";
    document.getElementById("fir_accagetype_error").innerHTML = "";
    document.getElementById("fir_accyob_error").innerHTML = "";
    document.getElementById("fir_accaddress_error").innerHTML = "";
    document.getElementById("fir_acccountry_error").innerHTML = "";
