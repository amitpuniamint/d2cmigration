...
function create_victim_list(row_id, from='insert'){
    ...
    'vic_gender': vic_gender, 'vic_gender_val': vic_gender_val,
...
function reset_property(){
    ...
    reset_text(["armsqty", "armsidentity", "armsinsurance", "armsestimate", "armsmodel", "autoestimate", "autoregistrationdate","autochasisno", "autoregnumber",
    ...
    "cyberaquisitiondetail2", "cybernetworkaquisition2", "cyberismobiledevice2"]);
