...
function chsdatetimecheck_func()
{
var today = new Date();
    ...
    else if($("#addcharge_act_sect").val() == "")
{
   ...
   accused_list[row_no].nonaccusedsplremark = '';
   document.getElementById('chsnonaccusedsplremark').value = '';
   accchs_act_sect = $("#addcharge_act_sect").val();
...
function save_nonchargesheet(row_no){
   row_no -= 1;
   // if($("#chsnonaccusedverified").val() == "")
   // {
   //  document.getElementById("chsnonaccusedverified_error").innerHTML = "Select Whether verified";
   ...
   //  $('#chsnonaccusedverified').css('border-color', 'red');
   ...
   //  $('#AddNonChargesheetForm').modal('show');
   //  return 1;
   // }

   // else if($("#chsnonaccusedaddverified").val() == "")
   // {
   //  document.getElementById("chsnonaccusedverified_error").innerHTML = "";
   //  document.getElementById("chsnonaccusedaddverified_error").innerHTML = "Select Address verified";
   //  document.getElementById("chsnonaccusedcourtfrwddate_error").innerHTML = "";
   //  document.getElementById("addnoncharge_act_sect_error").innerHTML = "";

   //  $('#chsnonaccusedverified').css('border-color', '');
   //  $('#chsnonaccusedaddverified').css('border-color', 'red');
   //  $('#chsnonaccusedcourtfrwddate').css('border-color', '');
   //  $('#addnoncharge_act_sect').css('border-color', '');
   ...
   // else if($("#chsnonaccusedcourtfrwddate").val() == "")
   // {
   //  document.getElementById("chsnonaccusedverified_error").innerHTML = "";
   //  document.getElementById("chsnonaccusedaddverified_error").innerHTML = "";
   //  document.getElementById("chsnonaccusedcourtfrwddate_error").innerHTML = "Select Date On Which Forwarded To Court";
   //  document.getElementById("addnoncharge_act_sect_error").innerHTML = "";

   //  $('#chsnonaccusedverified').css('border-color', '');
   //  $('#chsnonaccusedaddverified').css('border-color', '');
   //  $('#chsnonaccusedcourtfrwddate').css('border-color', 'red');
   //  $('#addnoncharge_act_sect').css('border-color', '');
   ...
   // else if($("#addnoncharge_act_sect").val() == "")
   // {
   //  document.getElementById("chsnonaccusedverified_error").innerHTML = "";
   //  document.getElementById("chsnonaccusedaddverified_error").innerHTML = "";
   //  document.getElementById("chsnonaccusedcourtfrwddate_error").innerHTML = "";
   //  document.getElementById("addnoncharge_act_sect_error").innerHTML = "Select Act & Section";

   //  $('#chsnonaccusedverified').css('border-color', '');
   //  $('#chsnonaccusedaddverified').css('border-color', '');
   //  $('#chsnonaccusedcourtfrwddate').css('border-color', '');
   //  $('#addnoncharge_act_sect').css('border-color', 'red');
...
function build_rows_witness(witness_list){
    ...
    witness_list.forEach(function(row, index){
        ...
        // edit_button = "<td><button class='btn btn-icon btn-warning center mr-1 mb-1' data-toggle='modal' data-target='#EditWitnessForm' onclick='edit_witness_row(\"witness_table\",\""+index+"\");'><i class='feather icon-menu' tooltip='Edit'></i></button></td>";
...
function create_witness_list(row_id, from='insert'){
    ...
    'witness_evidence_tendered':witness_evidence_tendered, "person_code": person_code, "witness_from": witness_from, "witness_from_srno": witness_from_srno,
...
// var i;
// for (i = 0; i < accused_list.length; i++) 
// {
// if (accused_list[i]["ischargesheet"] == '') 
// {
//     return false;
// }
// else
